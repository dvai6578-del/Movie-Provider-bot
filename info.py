...
PICS = (environ.get('PICS', 'https://t.me/SharbonsFilms')).split() #SAMPLE PIC
...
auth_channel = environ.get('AUTH_CHANNEL', '-1003026295500') #Channel / Group Id for force sub ( make sure bot is admin )
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1003090086608') # support group id ( make sure bot is admin )
reqst_channel = environ.get('REQST_CHANNEL_ID', '6182962779') # request channel id ( make sure bot is admin )
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/shrabonhibdimovies')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/shrabonhibdimovies') # Tutorial video link for opening shortlink website 
